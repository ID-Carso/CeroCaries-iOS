...
class DESeeCalendarViewController: BaseViewController, UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func GetStartDateDayPosition(){  //this functions gives us the number of empty boxes
          ...
          func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
              let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: "DESeeCalendarCell", for: indexPath) as! DESeeCalendarCollectionViewCell
    ...
    extension DESeeCalendarViewController: UICollectionViewDelegateFlowLayout {
