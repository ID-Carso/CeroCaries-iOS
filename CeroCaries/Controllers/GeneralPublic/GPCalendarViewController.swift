//
//  GPCalendarViewController.swift
//  CeroCaries
//
//  Created by Ricardo Olea on 30/06/20.
...
class GPCalendarViewController: BaseViewController, UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: "GPCalendar", for: indexPath) as! GPDateCollectionViewCell
        ...
        if currentMonth == Months[calendar.component(.month, from: date) - 1] && year == calendar.component(.year, from: date) && indexPath.row == day{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "GPCalendarDate", sender: nil)
...
extension GPCalendarViewController: UICollectionViewDelegateFlowLayout {
